package org.amolecoinj.integrations;
 ...
 */
public class AmolecoinNetParameters extends NetworkParameters{

    public AmolecoinNetParameters() {
        super();
        fixTimeWarpBug = true;
        ...
        blockVerifyFunction = new AmolecoinVerifyFunction();
        ...
        try {
            ...
            byte[] bytes = Utils.HEX.decode
                    ("ed8d7c9ca3c63d6fc8b16622696e0e15a3311600da0597db7c74d3b1088c2e14845c302c2f2ca07a57f44257d10c3b6a7da594071f363b28adfa58ba4a1987ef");
        ...
        genesisBlock.setDifficultyTarget(16384);
        genesisBlock.setTime(1550762794);
        genesisBlock.setNonce(513506);
        id = "org.amolecoin.production";
        subsidyDecreaseBlockCount = 840000;
        spendableCoinbaseDepth = 100;
        String genesisHash = genesisBlock.getHashAsString();
        System.out.println("Genesis hash:" + genesisHash);
        checkState(genesisHash.equals("f6904b36509f76daf61af044790a846eb45d9e2b21d98ff618d67329dcd3ad1c"),
                genesisHash);
        ...
        checkpoints.put(0, new Sha256Hash("0xf6904b36509f76daf61af044790a846eb45d9e2b21d98ff618d67329dcd3ad1c"));
       /* checkpoints.put(4032, new Sha256Hash("9ce90e427198fc0ef05e5905ce3503725b80e26afd35a987965fd7e3d9cf0846"));
        ...
        dnsSeeds = new String[] {
                "dnsseed.amolecointools.com",
                "dnsseed.amolecoinpool.org",
...
//        };
    ...
    private static AmolecoinNetParameters instance;
    public static synchronized AmolecoinNetParameters get() {
        if (instance == null) {
            instance = new AmolecoinNetParameters();
        }
        return instance;
    }
